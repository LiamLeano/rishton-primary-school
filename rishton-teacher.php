...
<html lang="en">
  	...
  	<head>
		...
		<title>Rishton Primary School - Teacher</title>
		<meta charset="utf-8">
  	...
  	<body>
		...
		<div class="content">
			<h1 class="content-header-xxxl">Teacher Form</h1>
			<h2 class="content-header-xxl">You can register a new Teacher by filling this form</h2>
            <h2 class="content-header-xxl">(Only one teacher can be in each classroom!)</h2> <br>

            
			
			<!--form-->
			<form method="post" action="rishton-teacher.php">
			...
			<h1 class="content-header-xxxl">Teacher Table</h1>
			<h2 class="content-header-xxl">You can see the list of Teachers below</h2> <br>
			...
			<table class="content-paragraph-xl">
				...
				<?php
				$sql = mysqli_query($link, "SELECT teacher_id, full_name, email_address, phone_number, class_id FROM teachers");
				while ($row = $sql->fetch_assoc()){
				echo "
				<tr>
			...
			if (isset($_POST['submit'])) {
				...
				$sql = "INSERT INTO teachers (first_name, last_name, full_name, email_address, phone_number, street_address, city, zip_address, medical_info, salary_per_hour, background_check, class_id)
				...
				echo "<hr><h2>New Teacher record created successfully! On the navigation bar, click the page 'Teacher' to see it!</h2>";
				} else {
